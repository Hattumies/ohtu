...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (Palautus palautus : palautukset.getPalautukset()) {
            System.out.println("viiko" +palautus.getViikko() + ": " +palautus.getTehtavia() + 
        ...
        System.out.println("yhteensä " + tehtavat + " tehtävää ja " + tunnit + " tuntia");
